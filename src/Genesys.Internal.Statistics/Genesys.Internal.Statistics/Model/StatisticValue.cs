...
namespace Genesys.Internal.Statistics.Model
{
    ...
    public partial class StatisticValue :  IEquatable<StatisticValue>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="Name">The name of the statistic used during the subscribe procedure..</param>
        /// <param name="ObjectId">The ID of the object (in Stat Server&#39;s terms)..</param>
        /// <param name="ObjectType">The type of object..</param>
        /// <param name="StatisticId">The ID of the statistic. This ID is unique inside the subscription..</param>
        ...
        /// </summary>
        /// <value>The name of the statistic used during the subscribe procedure.</value>
