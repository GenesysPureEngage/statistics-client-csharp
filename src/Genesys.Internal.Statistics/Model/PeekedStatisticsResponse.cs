...
namespace Genesys.Internal.Statistics.Model
{
    ...
    public partial class PeekedStatisticsResponse :  IEquatable<PeekedStatisticsResponse>, IValidatableObject
    {
        ...
        public PeekedStatisticsResponse(PeekedStatistics Data = default(PeekedStatistics), List<ErrorResponse> Errors = default(List<ErrorResponse>), string Path = default(string), ResponseStatus Status = default(ResponseStatus))
        {
        ...
        {
            return this.Equals(input as PeekedStatisticsResponse);
        }

        /// <summary>
        /// Returns true if PeekedStatisticsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of PeekedStatisticsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PeekedStatisticsResponse input)
        {
            if (input == null)
                return false;
