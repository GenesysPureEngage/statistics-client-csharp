...
namespace Genesys.Statistics.Model
{
    ...
    public partial class ApiResponse :  IEquatable<ApiResponse>, IValidatableObject
    {
        ...
        public ApiResponse(Object Data = default(Object), ApiResponse Errors = default(ApiResponse), string Path = default(string), ApiResponseStatus Status = default(ApiResponseStatus))
        {
