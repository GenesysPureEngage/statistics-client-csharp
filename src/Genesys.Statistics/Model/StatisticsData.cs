...
namespace Genesys.Statistics.Model
{
    ...
    public partial class StatisticsData :  IEquatable<StatisticsData>, IValidatableObject
    {
        ...
        public StatisticsData(StatisticsData Data = default(StatisticsData), ApiResponse Errors = default(ApiResponse), string Path = default(string), ApiResponseStatus Status = default(ApiResponseStatus))
        {
            // to ensure "Status" is required (not null)
            if (Status == null)
            {
                throw new InvalidDataException("Status is a required property for StatisticsData and cannot be null");
            }
            else
            {
                this.Status = Status;
        ...
        public ApiResponse Errors { get; set; }
