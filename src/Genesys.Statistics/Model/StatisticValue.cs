...
namespace Genesys.Statistics.Model
{
    ...
    public partial class StatisticValue :  IEquatable<StatisticValue>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="StatisticId">StatisticId.</param>
        /// <param name="Timestamp">Timestamp.</param>
        /// <param name="Value">Value.</param>
        public StatisticValue(string StatisticId = default(string), long? Timestamp = default(long?), Object Value = default(Object))
        {
