...
namespace Genesys.Statistics.Model
{
    ...
    public partial class StatisticValue :  IEquatable<StatisticValue>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="Name">name of statistic used during subscribe procedure.</param>
        /// <param name="ObjectId">Id (in StatServer&#39;s terms) of object.</param>
        /// <param name="ObjectType">Stat type of object.</param>
        /// <param name="StatisticId">The id of statistic (unique inside subscription).</param>
        ...
        public StatisticValue(string Name = default(string), string ObjectId = default(string), string ObjectType = default(string), string StatisticId = default(string), long? Timestamp = default(long?), Object Value = default(Object))
        {
            this.Name = Name;
        ...
        /// </summary>
        /// <value>name of statistic used during subscribe procedure</value>
        ...
        /// </summary>
        /// <value>The id of statistic (unique inside subscription)</value>
